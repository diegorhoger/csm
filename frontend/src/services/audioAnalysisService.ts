...
class AudioAnalysisService {
  ...
  async addAudioSample(audioLevel: number): Promise<AudioAnalysisResult> {
    ...
    try {
      const fullUrl = `${API_ENDPOINTS.baseUrl}/api/audio-analysis`;
  ...
  async forceRecalibration(): Promise<void> {
    try {
      const fullUrl = `${API_ENDPOINTS.baseUrl}/api/audio-analysis/calibrate`;
      const response = await fetch(fullUrl, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
  ...
  async getThreshold(): Promise<{threshold: number; noiseProfile: NoiseProfile}> {
    try {
      const fullUrl = `${API_ENDPOINTS.baseUrl}/api/audio-analysis/threshold`;
      const response = await fetch(fullUrl, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
  ...
  async updateConfig(config: AudioAnalysisConfig): Promise<void> {
    try {
      const fullUrl = `${API_ENDPOINTS.baseUrl}/api/audio-analysis/config`;
      const response = await fetch(fullUrl, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
  ...
  async getDebugState(): Promise<Record<string, unknown>> {
    try {
      const fullUrl = `${API_ENDPOINTS.baseUrl}/api/audio-analysis/debug`;
      const response = await fetch(fullUrl, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
